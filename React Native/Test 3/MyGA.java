...
@ReactMethod
public class MyGA extends ReactContextBaseJavaModule {
    private static ReactApplicationContext reactContext;

    MyGA(ReactApplicationContext context) {
        super(context);
        reactContext = context;
    }

    public static final String TARGET = "Test123Test Test123Test";
    ...
    @ReactMethod
    public static void runGA() throws InterruptedException {
        
        long startTime = System.currentTimeMillis();

        Random rn = new Random();
        MyGA run = new MyGA(reactContext);
        ...
        while (run.population.fittest < maxFitness && run.generationCount < 1000) { // <--- Max fitness
            ++run.generationCount;
